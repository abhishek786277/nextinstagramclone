    ...
    <div className="flex  items-center justify-center  gap-20 p-4 mt-7">
      ...
      <div className="flex flex-col items-center">
        <div className="border border-gray-300 p-8 flex flex-col items-center justify-center">
          <img src="Instagram_logo_black.webp" className="w-40 mb-10" alt=""/>
          <form action="" className="flex flex-col items-center gap-4">
            ...
            <p className="font-semibold text-blue-500 hover:underline cursor-pointer">
                <img src="googleimg.png" className="w-6 inline-block mx-2" alt=""/>  Log in with Google</p>
            <p className="font-semibold text-blue-500 cursor-pointer hover:underline"> <img  alt="" src="github.png" className="w-6 inline-block mx-3"/>Log in with Github</p>
        ...
        <div className="text-center mt-2">
          ...
          <div className="flex w-72 gap-2 mt-2">
            <img src="googleplay.png" className="w-1/2" alt="" />
            <img src="microsoft.png" className="w-1/2" alt="" />
          </div>
        </div>
        {/*  */}
      </div>
